...
import os
import pygame  # For playing the speech sound
...
def inference_thread(frame_queue, model, labels):
    ...
    while True:
        if not frame_queue.empty():
            ...
            # Convert the predicted label to Hindi speech using gTTS
            tts = gTTS(text=predicted_label, lang='hi')  # 'hi' is for Hindi
            tts.save("C:/Users/DELL/Desktop/gesture_audio.mp3")  # Or another directory


            # Play the generated speech file using pygame
            pygame.mixer.init()
            pygame.mixer.music.load("gesture_audio.mp3")
